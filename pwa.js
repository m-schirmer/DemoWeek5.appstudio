...
const cacheName = 'DemoWeek5-2021-09-20 15:45:54.943780'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'DemoWeek5'.length) === 'DemoWeek5') {
